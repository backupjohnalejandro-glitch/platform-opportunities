    ...
    <aside className="w-60 min-h-screen bg-slate-900 border-r border-slate-800 flex flex-col shrink-0">
      ...
      <div className="px-5 py-4 border-t border-slate-800 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-indigo-400 hover:text-indigo-300 hover:bg-indigo-950/60 border border-indigo-900/50 hover:border-indigo-800 transition-all"
        >
